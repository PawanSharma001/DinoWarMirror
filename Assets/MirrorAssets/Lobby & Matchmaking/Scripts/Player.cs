...
namespace MirrorBasics
{
    ...
    public class Player : NetworkBehaviour
    {
        ...
        void Update () {
                ...
                if (isLocalPlayer) {
                    playersConnected = currentMatch.players.Count;
                UILobby.instance.playerCountText.text = playersConnected.ToString()+"/15";
               }
        }
        ...
        */
        ...
        [TargetRpc]
        private void TargetPlayerCountUpdated(int playerCount)
        {
            if (playerCount > 1)
            {
